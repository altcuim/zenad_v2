...
RESOURCES += src/qt/zenad.qrc src/qt/zenad_locale.qrc

TRANSLATIONS += src/qt/locale/zenad_bg.ts \
                src/qt/locale/zenad_de.ts \
                src/qt/locale/zenad_en.ts \
                src/qt/locale/zenad_es.ts \
                src/qt/locale/zenad_fi.ts \
                src/qt/locale/zenad_fr.ts \
                src/qt/locale/zenad_it.ts \
                src/qt/locale/zenad_ja.ts \
                src/qt/locale/zenad_pl.ts \
                src/qt/locale/zenad_pt.ts \
                src/qt/locale/zenad_ru.ts \
                src/qt/locale/zenad_sk.ts \
                src/qt/locale/zenad_sv.ts \
                src/qt/locale/zenad_vi.ts \
                src/qt/locale/zenad_zh_CN.ts \
                src/qt/locale/zenad_zh_TW.ts
