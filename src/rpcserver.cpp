...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZND features */
        {"zenad", "masternode", &masternode, true, true, false},
        {"zenad", "masternodelist", &masternodelist, true, true, false},
        {"zenad", "mnbudget", &mnbudget, true, true, false},
        {"zenad", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"zenad", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zenad", "mnsync", &mnsync, true, true, false},
        {"zenad", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"zenad", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zenadd, or the -server option to zenad-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zenad-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15199/\n";
}
