/* src/config/zenad-config.h.  Generated from zenad-config.h.in by configure.  */
/* src/config/zenad-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://zenad.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Zenad Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Zenad Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zenad"
